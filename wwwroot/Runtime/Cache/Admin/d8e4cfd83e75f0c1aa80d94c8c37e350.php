...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="price" value="<?php echo ($data["price"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">类型<span class="check-tips"></span></label>
            <select class="item-label" name="type">
                <option value="<?php echo ($data["type"]); ?>">出租</option>
            </select>
        </div>
        <div class="form-item">
            <label class="item-label">上传图片<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="img" value="">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="date" class="text input-large" name="date" value="<?php echo ($data["date"]); ?>">
            </div>
        </div>
        <div class="form-item">
    ...
    <!--<script type="text/javascript">-->
        <!--//导航高亮-->
        <!--highlight_subnav('<?php echo U('Rent/index');?>');-->
    <!--</script>-->
<!--
</body>
</html>