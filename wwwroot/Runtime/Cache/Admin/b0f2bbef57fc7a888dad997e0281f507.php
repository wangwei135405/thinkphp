    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/admin.php?s=/Rent/index.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="data-table table-striped">
        <form class="ids">
            <table>
                ...
                <tbody>
                <?php if(!empty($rent)): if(is_array($rent)): $i = 0; $__LIST__ = $rent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rent): $mod = ($i % 2 );++$i;?><tr>
                            <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($rent["id"]); ?>"></td>
                            <td><?php echo ($rent["id"]); ?></td>
                            <!--<td>-->
                                <!--<a href="<?php echo U('index?pid='.$menu['id']);?>"><?php echo ($menu["title"]); ?></a>-->
                            <!--</td>-->
                            <td><?php echo ($rent["title"]); ?></td>
                            <td><?php echo ($rent["price"]); ?></td>
                            <td><?php echo ($rent["type"]); ?></td>
                            <td><?php echo ($rent["img"]); ?></td>
                            <td><?php echo ($rent["content"]); ?></td>
                            <td><?php echo ($rent["description"]); ?></td>
                            <td><?php echo ($rent["date"]); ?></td>
                            <td><?php echo ($rent["tel"]); ?></td>

                            <td>
                                <a title="编辑" href="<?php echo U('edit?id='.$rent['id']);?>">编辑</a>
                                <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$rent['id']);?>">删除</a>
                            </td>
